...
class Rediska_Key extends Rediska_Key_Abstract implements Countable, ArrayAccess
{
    ...
    public function setAndExpire($value, $seconds)
    {
        return $this->_getRediskaOn()
            ->setAndExpire($this->getName(), $value, $seconds);
    }
    ...
    {
        return $this->_getRediskaOn()
            ->setRange($this->getName(), $offset, $value);
    }
    ...
    {
        return $this->_getRediskaOn()
            ->substring($this->getName(), $start, $end);
    }
     ...
     */
    public function getOrSetValue(
        $object = null,
        $expire = null,
        $expireIsTimestamp = false
    ) {
        return new Rediska_Key_GetOrSetValue($this, $object, $expire,
            $expireIsTimestamp);
    }
