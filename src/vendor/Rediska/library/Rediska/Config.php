...
class Rediska_Config implements IteratorAggregate, ArrayAccess, Countable
{
    ...
    {
        $configGet = new Rediska_Connection_Exec($this->_connection,
            array('CONFIG', 'GET', $nameOrPattern));
    ...
    {
        $exec = new Rediska_Connection_Exec($this->_connection,
            array('CONFIG', 'SET', $name, $value));
        $exec->execute();
