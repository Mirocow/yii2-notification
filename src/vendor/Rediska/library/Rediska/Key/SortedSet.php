...
class Rediska_Key_SortedSet extends Rediska_Key_Abstract implements IteratorAggregate, ArrayAccess, Countable
{
    ...
    {
        $result = $this->_getRediskaOn()
            ->addToSortedSet($this->getName(), $value, $score);
    ...
    {
        $result = $this->_getRediskaOn()
            ->deleteFromSortedSet($this->getName(), $value);
    ...
    {
        return $this->_getRediskaOn()
            ->getSortedSetLengthByScore($this->getName(), $min, $max);
    }
    ...
    public function getByScore(
        ...
        return $this->_getRediskaOn()
            ->getFromSortedSetByScore($this->getName(), $min, $max, $withScores,
                $limit, $offset);
    }
    ...
    {
        return $this->_getRediskaOn()
            ->DeleteFromSortedSetByScore($this->getName(), $min, $max);
    }
    ...
    {
        return $this->_getRediskaOn()
            ->getScoreFromSortedSet($this->getName(), $value);
    }
    ...
    {
        return $this->_getRediskaOn()
            ->incrementScoreInSortedSet($this->getName(), $value, $score);
    }
    ...
    public function getByRank(
        ...
        return $this->_getRediskaOn()
            ->getSortedSet($this->getName(), $withScores, $start, $end, $revert,
                $responseIterator);
    }
    ...
    {
        return $this->_getRediskaOn()
            ->deleteFromSortedSetByRank($this->getName(), $start, $end);
    }
    ...
    {
        return $this->_getRediskaOn()
            ->getRankFromSortedSet($this->getName(), $value, $revert);
    }
    ...
    public function union($setOrSets, $storeKeyName, $aggregation = 'sum')
    {
        ...
        return $this->_getRediskaOn()
            ->unionSortedSets($sets, $storeKeyName, $aggregation);
    }
    ...
    public function intersect($setOrSets, $storeKeyName, $aggregation = 'sum')
    {
        ...
        return $this->_getRediskaOn()
            ->intersectSortedSets($sets, $storeKeyName, $aggregation);
    }
    ...
    public function toArray(
        ...
        return $this->getByRank($withScores, $start, $end, $revert,
            $responseIterator);
    }
    ...
    public function fromArray(array $array)
    {
        ...
        if (!is_null($this->getExpire())) {
            $pipeline->expire($this->getName(), $this->getExpire(),
                $this->isExpireTimestamp());
        }
