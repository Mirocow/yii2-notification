...
class Rediska_Key_Hash extends Rediska_Key_Abstract implements IteratorAggregate, ArrayAccess, Countable
{
    ...
    public function set($fieldOrData, $value = null, $overwrite = true)
    {
        $result = $this->_getRediskaOn()
            ->setToHash($this->getName(), $fieldOrData, $value, $overwrite);
    ...
    public function get($fieldOrFields)
    {
        return $this->_getRediskaOn()
            ->getFromHash($this->getName(), $fieldOrFields);
    }
    ...
    {
        $result = $this->_getRediskaOn()
            ->incrementInHash($this->getName(), $field, $amount);
    ...
    {
        $result = $this->_getRediskaOn()
            ->deleteFromHash($this->getName(), $field);
