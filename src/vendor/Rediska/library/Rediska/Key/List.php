...
class Rediska_Key_List extends Rediska_Key_Abstract implements IteratorAggregate, ArrayAccess, Countable
{
    ...
    public function append($value, $createIfNotExists = true)
    {
        $result = $this->_getRediskaOn()
            ->appendToList($this->getName(), $value, $createIfNotExists);
    ...
    {
        $result = $this->_getRediskaOn()
            ->prependToList($this->getName(), $value, $createIfNotExists);
    ...
    {
        $result = $this->_getRediskaOn()
            ->truncateList($this->getName(), $start, $end);
    ...
    {
        $result = $this->_getRediskaOn()
            ->setToList($this->getName(), $index, $value);
    ...
    public function insertAfter($referenceValue, $value)
    {
        return $this->_getRediskaOn()
            ->insertToListAfter($this->getName(), $referenceValue, $value);
    }
    ...
    {
        return $this->_getRediskaOn()
            ->insertToListBefore($this->getName(), $referenceValue, $value);
    }
    ...
    {
        return $this->_getRediskaOn()
            ->insertToList($this->getName(), $position, $referenceValue,
                $value);
    }
    ...
    {
        $result = $this->_getRediskaOn()
            ->deleteFromList($this->getName(), $value, $count);
    ...
    {
        $result = $this->_getRediskaOn()
            ->shiftFromListBlocking($this->getName(), $timeout);
    ...
    public function pop($pushTo = null)
    {
        ...
        $result = $this->_getRediskaOn()
            ->popFromList($this->getName(), $pushTo);
    ...
    {
        $result = $this->_getRediskaOn()
            ->popFromListBlocking($this->getName(), $timeout, $pushToKey);
    ...
    {
        return $this->_getRediskaOn()
            ->getList($this->getName(), $start, $end, $responseIterator);
    }
