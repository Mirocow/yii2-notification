...
class Rediska_Transaction
{
    ...
    public function __construct(
        Rediska $rediska,
        Rediska_Connection_Specified $specifiedConnection,
        Rediska_Connection $connection
    ) {
    ...
    public function __call($name, $args)
    {
        if (in_array(strtolower($name),
            array('on', 'pipeline', 'monitor', 'config', 'subscribe'))) {
    ...
    protected function _throwIfNotSupported($title, $version)
    {
        ...
        if (version_compare($version,
                $this->_rediska->getOption('redisVersion')) == 1
        ) {
    ...
    public function quit()
    {
        ...
        return $this->_addCommand('quit', $args);
    }
    ...
    public function exists($key)
    {
        ...
        return $this->_addCommand('exists', $args);
    }
    ...
    public function delete($keyOrKeys)
    {
        ...
        return $this->_addCommand('delete', $args);
    }
    ...
    public function getType($key)
    {
        ...
        return $this->_addCommand('getType', $args);
    }
    ...
    public function getKeysByPattern($pattern)
    {
        ...
        return $this->_addCommand('getKeysByPattern', $args);
    }
    ...
    public function getRandomKey()
    {
        ...
        return $this->_addCommand('getRandomKey', $args);
    }
    ...
    public function rename($oldKey, $newKey, $overwrite = true)
    {
        ...
        return $this->_addCommand('rename', $args);
    }
    ...
    public function getKeysCount()
    {
        ...
        return $this->_addCommand('getKeysCount', $args);
    }
    ...
    public function expire($key, $secondsOrTimestamp, $isTimestamp = false)
    {
        ...
        return $this->_addCommand('expire', $args);
    }
    ...
    public function getLifetime($key)
    {
        ...
        return $this->_addCommand('getLifetime', $args);
    }
    ...
    public function selectDb($index)
    {
        ...
        return $this->_addCommand('selectDb', $args);
    }
    ...
    public function moveToDb($key, $dbIndex)
    {
        ...
        return $this->_addCommand('moveToDb', $args);
    }
    ...
    public function flushDb($all = false)
    {
        ...
        return $this->_addCommand('flushDb', $args);
    }
    ...
    public function setAndExpire($key, $value, $seconds)
    {
        ...
        return $this->_addCommand('setAndExpire', $args);
    }
    ...
    public function setAndGet($key, $value)
    {
        ...
        return $this->_addCommand('setAndGet', $args);
    }
    ...
    public function get($keyOrKeys)
    {
        ...
        return $this->_addCommand('get', $args);
    }
    ...
    public function append($key, $value)
    {
        ...
        return $this->_addCommand('append', $args);
    }
    ...
    public function increment($key, $amount = 1)
    {
        ...
        return $this->_addCommand('increment', $args);
    }
    ...
    public function decrement($key, $amount = 1)
    {
        ...
        return $this->_addCommand('decrement', $args);
    }
    ...
    public function setRange($key, $offset, $value)
    {
        ...
        return $this->_addCommand('setRange', $args);
    }
    ...
    public function getRange($key, $start, $end = -1)
    {
        ...
        return $this->_addCommand('getRange', $args);
    }
    ...
    public function substring($key, $start, $end = -1)
    {
        ...
        return $this->_addCommand('substring', $args);
    }
    ...
    public function setBit($key, $offset, $bit)
    {
        ...
        return $this->_addCommand('setBit', $args);
    }
    ...
    public function getBit($key, $offset)
    {
        ...
        return $this->_addCommand('getBit', $args);
    }
    ...
    public function getLength($key)
    {
        ...
        return $this->_addCommand('getLength', $args);
    }
    ...
    public function appendToList($key, $value, $createIfNotExists = true)
    {
        ...
        return $this->_addCommand('appendToList', $args);
    }
    ...
    public function prependToList($key, $value, $createIfNotExists = true)
    {
        ...
        return $this->_addCommand('prependToList', $args);
    }
    ...
    public function getListLength($key)
    {
        ...
        return $this->_addCommand('getListLength', $args);
    }
    ...
    public function getList(
        ...
        return $this->_addCommand('getList', $args);
    }
    ...
    public function truncateList($key, $start, $end)
    {
        ...
        return $this->_addCommand('truncateList', $args);
    }
    ...
    public function getFromList($key, $index)
    {
        ...
        return $this->_addCommand('getFromList', $args);
    }
    ...
    public function setToList($key, $index, $member)
    {
        ...
        return $this->_addCommand('setToList', $args);
    }
    ...
    public function deleteFromList($key, $value, $count = 0)
    {
        ...
        return $this->_addCommand('deleteFromList', $args);
    }
    ...
    public function shiftFromList($key)
    {
        ...
        return $this->_addCommand('shiftFromList', $args);
    }
    ...
    public function shiftFromListBlocking($keyOrKeys, $timeout = 0)
    {
        ...
        return $this->_addCommand('shiftFromListBlocking', $args);
    }
    ...
    public function popFromList($key, $pushToKey = null)
    {
        ...
        return $this->_addCommand('popFromList', $args);
    }
    ...
    public function popFromListBlocking(
        ...
        return $this->_addCommand('popFromListBlocking', $args);
    }
    ...
    public function insertToList($key, $position, $referenceValue, $value)
    {
        ...
        return $this->_addCommand('insertToList', $args);
    }
    ...
    public function insertToListAfter($key, $referenceValue, $value)
    {
        ...
        return $this->_addCommand('insertToListAfter', $args);
    }
    ...
    public function insertToListBefore($key, $referenceValue, $value)
    {
        ...
        return $this->_addCommand('insertToListBefore', $args);
    }
    ...
    public function addToSet($key, $member)
    {
        ...
        return $this->_addCommand('addToSet', $args);
    }
    ...
    public function deleteFromSet($key, $member)
    {
        ...
        return $this->_addCommand('deleteFromSet', $args);
    }
    ...
    public function getRandomFromSet($key, $pop = false)
    {
        ...
        return $this->_addCommand('getRandomFromSet', $args);
    }
    ...
    public function getSetLength($key)
    {
        ...
        return $this->_addCommand('getSetLength', $args);
    }
    ...
    public function existsInSet($key, $member)
    {
        ...
        return $this->_addCommand('existsInSet', $args);
    }
    ...
    public function intersectSets(array $keys, $storeKey = null)
    {
        ...
        return $this->_addCommand('intersectSets', $args);
    }
    ...
    public function unionSets(array $keys, $storeKey = null)
    {
        ...
        return $this->_addCommand('unionSets', $args);
    }
    ...
    public function diffSets(array $keys, $storeKey = null)
    {
        ...
        return $this->_addCommand('diffSets', $args);
    }
    ...
    public function getSet($key, $responseIterator = false)
    {
        ...
        return $this->_addCommand('getSet', $args);
    }
    ...
    public function moveToSet($fromKey, $toKey, $member)
    {
        ...
        return $this->_addCommand('moveToSet', $args);
    }
    ...
    public function addToSortedSet($key, $member, $score)
    {
        ...
        return $this->_addCommand('addToSortedSet', $args);
    }
    ...
    public function deleteFromSortedSet($key, $member)
    {
        ...
        return $this->_addCommand('deleteFromSortedSet', $args);
    }
    ...
    public function getSortedSet(
        ...
        return $this->_addCommand('getSortedSet', $args);
    }
    ...
    public function getFromSortedSetByScore(
        ...
        return $this->_addCommand('getFromSortedSetByScore', $args);
    }
    ...
    public function getSortedSetLength($key)
    {
        ...
        return $this->_addCommand('getSortedSetLength', $args);
    }
    ...
    public function getSortedSetLengthByScore($key, $min, $max)
    {
        ...
        return $this->_addCommand('getSortedSetLengthByScore', $args);
    }
    ...
    public function incrementScoreInSortedSet($key, $value, $score)
    {
        ...
        return $this->_addCommand('incrementScoreInSortedSet', $args);
    }
    ...
    public function deleteFromSortedSetByScore($key, $min, $max)
    {
        ...
        return $this->_addCommand('deleteFromSortedSetByScore', $args);
    }
    ...
    public function deleteFromSortedSetByRank($key, $start, $end)
    {
        ...
        return $this->_addCommand('deleteFromSortedSetByRank', $args);
    }
    ...
    public function getScoreFromSortedSet($key, $member)
    {
        ...
        return $this->_addCommand('getScoreFromSortedSet', $args);
    }
    ...
    public function getRankFromSortedSet($key, $member, $revert = false)
    {
        ...
        return $this->_addCommand('getRankFromSortedSet', $args);
    }
    ...
    public function unionSortedSets(
        ...
        return $this->_addCommand('unionSortedSets', $args);
    }
    ...
    public function intersectSortedSets(
        ...
        return $this->_addCommand('intersectSortedSets', $args);
    }
    ...
    public function setToHash(
        ...
        return $this->_addCommand('setToHash', $args);
    }
    ...
    public function getFromHash($key, $fieldOrFields)
    {
        ...
        return $this->_addCommand('getFromHash', $args);
    }
    ...
    public function incrementInHash($key, $field, $amount = 1)
    {
        ...
        return $this->_addCommand('incrementInHash', $args);
    }
    ...
    public function existsInHash($key, $field)
    {
        ...
        return $this->_addCommand('existsInHash', $args);
    }
    ...
    public function deleteFromHash($key, $field)
    {
        ...
        return $this->_addCommand('deleteFromHash', $args);
    }
    ...
    public function getHashLength($key)
    {
        ...
        return $this->_addCommand('getHashLength', $args);
    }
    ...
    public function getHash($key)
    {
        ...
        return $this->_addCommand('getHash', $args);
    }
    ...
    public function getHashFields($key)
    {
        ...
        return $this->_addCommand('getHashFields', $args);
    }
    ...
    public function getHashValues($key)
    {
        ...
        return $this->_addCommand('getHashValues', $args);
    }
    ...
    public function sort($key, array $options = array())
    {
        ...
        return $this->_addCommand('sort', $args);
    }
    ...
    public function publish($channelOrChannels, $message)
    {
        ...
        return $this->_addCommand('publish', $args);
    }
    ...
    public function save($background = false)
    {
        ...
        return $this->_addCommand('save', $args);
    }
    ...
    public function getLastSaveTime()
    {
        ...
        return $this->_addCommand('getLastSaveTime', $args);
    }
    ...
    public function shutdown()
    {
        ...
        return $this->_addCommand('shutdown', $args);
    }
    ...
    public function rewriteAppendOnlyFile()
    {
        ...
        return $this->_addCommand('rewriteAppendOnlyFile', $args);
    }
    ...
    public function info()
    {
        ...
        return $this->_addCommand('info', $args);
    }
    ...
    public function slaveOf($aliasOrConnection)
    {
        ...
        return $this->_addCommand('slaveOf', $args);
    }
