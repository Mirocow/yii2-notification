...
class Rediska extends Rediska_Options
{
    ...
    public function setServers(array $servers)
    {
        ...
        foreach ($servers as $alias => $serverOptions) {
            ...
            $this->addServer(isset($serverOptions['host']) ? $serverOptions['host'] : Rediska_Connection::DEFAULT_HOST,
    ...
    public function transaction($aliasOrConnection = null)
    {
        ...
        return new Rediska_Transaction($this, $this->_specifiedConnection,
            $connection);
    }
    ...
    public function getProfiler()
    {
        if (!$this->_profiler) {
            if ($this->_options['profiler'] === false) {
                ...
                } else if (in_array($this->_options['profiler']['name'],
                    array('stream'))) {
    ...
    public function quit()
    {
        ...
        return $this->_executeCommand('quit', $args);
    }
    ...
    public function exists($key)
    {
        ...
        return $this->_executeCommand('exists', $args);
    }
    ...
    public function delete($keyOrKeys)
    {
        ...
        return $this->_executeCommand('delete', $args);
    }
    ...
    public function getType($key)
    {
        ...
        return $this->_executeCommand('getType', $args);
    }
    ...
    public function getKeysByPattern($pattern)
    {
        ...
        return $this->_executeCommand('getKeysByPattern', $args);
    }
    ...
    public function getRandomKey()
    {
        ...
        return $this->_executeCommand('getRandomKey', $args);
    }
    ...
    public function rename($oldKey, $newKey, $overwrite = true)
    {
        ...
        return $this->_executeCommand('rename', $args);
    }
    ...
    public function getKeysCount()
    {
        ...
        return $this->_executeCommand('getKeysCount', $args);
    }
    ...
    public function expire($key, $secondsOrTimestamp, $isTimestamp = false)
    {
        ...
        return $this->_executeCommand('expire', $args);
    }
    ...
    public function getLifetime($key)
    {
        ...
        return $this->_executeCommand('getLifetime', $args);
    }
    ...
    public function selectDb($index)
    {
        ...
        return $this->_executeCommand('selectDb', $args);
    }
     ...
     * @return boolean
     */
    public function moveToDb($key, $dbIndex)
    {
        $args = func_get_args();

        return $this->_executeCommand('moveToDb', $args);
    }
    ...
    public function flushDb($all = false)
    {
        ...
        return $this->_executeCommand('flushDb', $args);
    }
     ...
     * @return mixed
     */
    public function set($keyOrData, $valueOrOverwrite = null, $overwrite = true)
    {
        $args = func_get_args();

        return $this->_executeCommand('set', $args);
    }
    ...
    public function setAndExpire($key, $value, $seconds)
    {
        ...
        return $this->_executeCommand('setAndExpire', $args);
    }
     ...
     * @return mixed
     */
    public function setAndGet($key, $value)
    {
        $args = func_get_args();

        return $this->_executeCommand('setAndGet', $args);
    }
    ...
    public function get($keyOrKeys)
    {
        ...
        return $this->_executeCommand('get', $args);
    }
    ...
    public function append($key, $value)
    {
        ...
        return $this->_executeCommand('append', $args);
    }
    ...
    public function increment($key, $amount = 1)
    {
        ...
        return $this->_executeCommand('increment', $args);
    }
    ...
    public function decrement($key, $amount = 1)
    {
        ...
        return $this->_executeCommand('decrement', $args);
    }
    ...
    public function setRange($key, $offset, $value)
    {
        ...
        return $this->_executeCommand('setRange', $args);
    }
     ...
     * @return mixin
     */
    public function getRange($key, $start, $end = -1)
    {
        $args = func_get_args();

        return $this->_executeCommand('getRange', $args);
    }
     ...
     * @return mixin
     */
    public function substring($key, $start, $end = -1)
    {
        $args = func_get_args();

        return $this->_executeCommand('substring', $args);
    }
    ...
    public function setBit($key, $offset, $bit)
    {
        ...
        return $this->_executeCommand('setBit', $args);
    }
    ...
    public function getBit($key, $offset)
    {
        ...
        return $this->_executeCommand('getBit', $args);
    }
    ...
    public function getLength($key)
    {
        ...
        return $this->_executeCommand('getLength', $args);
    }
     ...
     * @return mixed
     */
    public function appendToList($key, $value, $createIfNotExists = true)
    {
        $args = func_get_args();

        return $this->_executeCommand('appendToList', $args);
    }
     ...
     * @return mixed
     */
    public function prependToList($key, $value, $createIfNotExists = true)
    {
        $args = func_get_args();

        return $this->_executeCommand('prependToList', $args);
    }
    ...
    public function getListLength($key)
    {
        ...
        return $this->_executeCommand('getListLength', $args);
    }
    ...
    public function getList(
        ...
        $start = 0,
        $end = -1,
        $responseIterator = false
    ) {
        $args = func_get_args();

        return $this->_executeCommand('getList', $args);
    }
     ...
     * @return boolean
     */
    public function truncateList($key, $start, $end)
    {
        $args = func_get_args();

        return $this->_executeCommand('truncateList', $args);
    }
     ...
     * @return mixed
     */
    public function getFromList($key, $index)
    {
        $args = func_get_args();

        return $this->_executeCommand('getFromList', $args);
    }
     ...
     * @return boolean
     */
    public function setToList($key, $index, $member)
    {
        $args = func_get_args();

        return $this->_executeCommand('setToList', $args);
    }
    ...
    public function deleteFromList($key, $value, $count = 0)
    {
        ...
        return $this->_executeCommand('deleteFromList', $args);
    }
     ...
     * @return mixed
     */
    public function shiftFromList($key)
    {
        $args = func_get_args();

        return $this->_executeCommand('shiftFromList', $args);
    }
     ...
     * @return mixed
     */
    public function shiftFromListBlocking($keyOrKeys, $timeout = 0)
    {
        $args = func_get_args();

        return $this->_executeCommand('shiftFromListBlocking', $args);
    }
     ...
     * @return mixed
     */
    public function popFromList($key, $pushToKey = null)
    {
        $args = func_get_args();

        return $this->_executeCommand('popFromList', $args);
    }
     ...
     * @return mixed
     */
    public function popFromListBlocking(
        $keyOrKeys,
        $timeout = 0,
        $pushToKey = null
    ) {
        ...
        return $this->_executeCommand('popFromListBlocking', $args);
    }
     ...
     */
    public function insertToList($key, $position, $referenceValue, $value)
    {
        $args = func_get_args();

        return $this->_executeCommand('insertToList', $args);
    }
     ...
     * @return integer|boolean
     */
    public function insertToListAfter($key, $referenceValue, $value)
    {
        $args = func_get_args();

        return $this->_executeCommand('insertToListAfter', $args);
    }
     ...
     * @return integer|boolean
     */
    public function insertToListBefore($key, $referenceValue, $value)
    {
        $args = func_get_args();

        return $this->_executeCommand('insertToListBefore', $args);
    }
    ...
    public function addToSet($key, $member)
    {
        ...
        return $this->_executeCommand('addToSet', $args);
    }
     ...
     * @return boolean
     */
    public function deleteFromSet($key, $member)
    {
        $args = func_get_args();

        return $this->_executeCommand('deleteFromSet', $args);
    }
     ...
     * @return mixed
     */
    public function getRandomFromSet($key, $pop = false)
    {
        $args = func_get_args();

        return $this->_executeCommand('getRandomFromSet', $args);
    }
    ...
    public function getSetLength($key)
    {
        ...
        return $this->_executeCommand('getSetLength', $args);
    }
    ...
    public function existsInSet($key, $member)
    {
        ...
        return $this->_executeCommand('existsInSet', $args);
    }
     ...
     * @return mixed
     */
    public function intersectSets(array $keys, $storeKey = null)
    {
        $args = func_get_args();

        return $this->_executeCommand('intersectSets', $args);
    }
     ...
     * @return mixed
     */
    public function unionSets(array $keys, $storeKey = null)
    {
        $args = func_get_args();

        return $this->_executeCommand('unionSets', $args);
    }
     ...
     * @return mixed
     */
    public function diffSets(array $keys, $storeKey = null)
    {
        $args = func_get_args();

        return $this->_executeCommand('diffSets', $args);
    }
     ...
     * @return array
     */
    public function getSet($key, $responseIterator = false)
    {
        $args = func_get_args();

        return $this->_executeCommand('getSet', $args);
    }
     ...
     * @return mixed
     */
    public function moveToSet($fromKey, $toKey, $member)
    {
        $args = func_get_args();

        return $this->_executeCommand('moveToSet', $args);
    }
     ...
     * @return boolean
     */
    public function addToSortedSet($key, $member, $score)
    {
        $args = func_get_args();

        return $this->_executeCommand('addToSortedSet', $args);
    }
     ...
     * @return boolean
     */
    public function deleteFromSortedSet($key, $member)
    {
        $args = func_get_args();

        return $this->_executeCommand('deleteFromSortedSet', $args);
    }
    ...
    public function getSortedSet(
        ...
        return $this->_executeCommand('getSortedSet', $args);
    }
     ...
     * @return array
     */
    public function getFromSortedSetByScore(
        $key,
        $min,
        $max,
        $withScores = false,
        ...
        return $this->_executeCommand('getFromSortedSetByScore', $args);
    }
    ...
    public function getSortedSetLength($key)
    {
        ...
        return $this->_executeCommand('getSortedSetLength', $args);
    }
     ...
     * @return mixed
     */
    public function getSortedSetLengthByScore($key, $min, $max)
    {
        $args = func_get_args();

        return $this->_executeCommand('getSortedSetLengthByScore', $args);
    }
     ...
     * @return mixed
     */
    public function incrementScoreInSortedSet($key, $value, $score)
    {
        $args = func_get_args();

        return $this->_executeCommand('incrementScoreInSortedSet', $args);
    }
    ...
    public function deleteFromSortedSetByScore($key, $min, $max)
    {
        ...
        return $this->_executeCommand('deleteFromSortedSetByScore', $args);
    }
     ...
     * @return mixed
     */
    public function deleteFromSortedSetByRank($key, $start, $end)
    {
        $args = func_get_args();

        return $this->_executeCommand('deleteFromSortedSetByRank', $args);
    }
    ...
    public function getScoreFromSortedSet($key, $member)
    {
        ...
        return $this->_executeCommand('getScoreFromSortedSet', $args);
    }
    ...
    public function getRankFromSortedSet($key, $member, $revert = false)
    {
        ...
        return $this->_executeCommand('getRankFromSortedSet', $args);
    }
     ...
     * @return mixed
     */
    public function unionSortedSets(
        array $keys,
        $storeKey,
        $aggregation = Rediska_Command_UnionSortedSets::SUM
    ) {
        $args = func_get_args();

        return $this->_executeCommand('unionSortedSets', $args);
    }
     ...
     * @return mixed
     */
    public function intersectSortedSets(
        array $keys,
        $storeKey,
        $aggregation = Rediska_Command_IntersectSortedSets::SUM
    ) {
        $args = func_get_args();

        return $this->_executeCommand('intersectSortedSets', $args);
    }
    ...
    public function setToHash(
        ...
        return $this->_executeCommand('setToHash', $args);
    }
     ...
     * @return mixed
     */
    public function getFromHash($key, $fieldOrFields)
    {
        $args = func_get_args();

        return $this->_executeCommand('getFromHash', $args);
    }
    ...
    public function incrementInHash($key, $field, $amount = 1)
    {
        ...
        return $this->_executeCommand('incrementInHash', $args);
    }
     ...
     * @return boolean
     */
    public function existsInHash($key, $field)
    {
        $args = func_get_args();

        return $this->_executeCommand('existsInHash', $args);
    }
     ...
     * @return boolean
     */
    public function deleteFromHash($key, $field)
    {
        $args = func_get_args();

        return $this->_executeCommand('deleteFromHash', $args);
    }
    ...
    public function getHashLength($key)
    {
        ...
        return $this->_executeCommand('getHashLength', $args);
    }
    ...
    public function getHash($key)
    {
        ...
        return $this->_executeCommand('getHash', $args);
    }
    ...
    public function getHashFields($key)
    {
        ...
        return $this->_executeCommand('getHashFields', $args);
    }
    ...
    public function getHashValues($key)
    {
        ...
        return $this->_executeCommand('getHashValues', $args);
    }
    ...
    public function sort($key, array $options = array())
    {
        ...
        return $this->_executeCommand('sort', $args);
    }
     ...
     * @return mixed
     */
    public function publish($channelOrChannels, $message)
    {
        $args = func_get_args();

        return $this->_executeCommand('publish', $args);
    }
    ...
    public function save($background = false)
    {
        ...
        return $this->_executeCommand('save', $args);
    }
    ...
    public function getLastSaveTime()
    {
        ...
        return $this->_executeCommand('getLastSaveTime', $args);
    }
    ...
    public function shutdown()
    {
        ...
        return $this->_executeCommand('shutdown', $args);
    }
    ...
    public function rewriteAppendOnlyFile()
    {
        ...
        return $this->_executeCommand('rewriteAppendOnlyFile', $args);
    }
    ...
    public function info()
    {
        ...
        return $this->_executeCommand('info', $args);
    }
     ...
     * @return mixed
     */
    public function slaveOf($aliasOrConnection)
    {
        $args = func_get_args();

        return $this->_executeCommand('slaveOf', $args);
    }
