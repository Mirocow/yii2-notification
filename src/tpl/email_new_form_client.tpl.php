        ...
        <td>
            ...
            <p class="h3"
               style="font-size: 15px; padding-top: 4px; padding-right: 4px; padding-bottom: 4px; padding-left: 0px; font-weight: normal; line-height: 19px; font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; text-align: left; margin: 0px;">
                <span style="color: #ff0000;">Ваша заявка на размещение рекламы на нашем портале принята</span>
            </p>
            ...
            <p
                ...
                Ваша заявка на размещение рекламы на нашем портале принята
                В ближайшее время с Вами свяжется наш менеджер для обсуждения
                деталей сотрудничества.
                Вы можете сами позвонить в будни с 10 до 18 часов по московскому
                времени по т .8 (495) 221-59-51

                Кроме того
                Вы успешно зарегистрировались на портале vse-avtoservisy.ru
                Для входа в личный кабинет участника перейдите по ссылке
                <a href="{joint_into_profile_url_urlencode}">{joint_into_profile_url}</a><br><br>
                В личном кабинете Вы можете сменить пароль, на более удобный…
